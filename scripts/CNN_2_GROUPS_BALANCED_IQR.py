...
def save_results_all_in_one(train_metrics, train_confusion_mtx, y_train, 
    ...
    file_path = fr'G:\My Drive\Thesis\Temp_Work\excel_files_final\CNN_results\results_2_classes_groups_balanced_seed_77_IQR\results2_{param_name}.xlsx'
...
def split_groups(groups_list):
    train_groups, temp_groups = train_test_split(groups_list, test_size=0.25, random_state=77)
    val_groups, test_groups = train_test_split(temp_groups, test_size=0.4, random_state=77)
